    ...
    return (
        <div className='content'>
            ...
            {selectedLanguage === "RU" &&
                <div>
                    <div className='title'>
                        <h1 className="inline-title">Контакты</h1>
                        <p className="lain-text">Телерадиокомпания «СТАРТ» 107023 Москва Электрозаводская 32а</p>
                    </div>
                    ...
                    <div className='infor'>
                        <p className="contacts-text">Общество с ограниченной ответственностью «Телерадиокомпания «Старт» ИНН 7722510229/КПП 771801001 ОГРН 1047796200671 Юридический адрес 107023, г. Москва, вн. тер. г. муниципальный округ Преображенское, ул. Электрозаводская, д. 32А. <br/>
                            <a href="http://tvstart.ru//app/uploads/2022/05/user_agreements.pdf"> Пользовательское соглашение </a>
                        </p>
                    </div>
                </div>
            }
